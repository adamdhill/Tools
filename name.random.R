#Use usagov/Federal-Agency-Directory-API-Documentation to pull in names, replacing "Agencies"
#https://www.usa.gov/api/USAGovAPI/contacts.json/contacts --> provides names of all agencies
#Example:     "Name" : "Employee Benefits Security Administration (EBSA)"
#Pull out what is in parens 


json <- fromJSON(getURL('https://www.usa.gov/api/USAGovAPI/contacts.json/contacts'))



#Prior methods

#baseurl <- paste('https://www.usa.gov/api/USAGovAPI/contacts.json/contacts')
#Get complete list of agencies

#x <- GET(url = paste(baseurl))



#US federal agencies, available at http://www2.gwu.edu/~nsarchiv/NSAEBB/NSAEBB216/app1.pdf
#Todo: incorporate this larger list of agencies --> http://www.usa.gov/directory/federal/
